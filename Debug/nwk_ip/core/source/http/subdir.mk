...
nwk_ip/core/source/http/%.o: ../nwk_ip/core/source/http/%.c nwk_ip/core/source/http/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-nwk_ip-2f-core-2f-source-2f-http

clean-nwk_ip-2f-core-2f-source-2f-http:
	-$(RM) ./nwk_ip/core/source/http/http.d ./nwk_ip/core/source/http/http.o ./nwk_ip/core/source/http/http_client.d ./nwk_ip/core/source/http/http_client.o ./nwk_ip/core/source/http/http_server.d ./nwk_ip/core/source/http/http_server.o

.PHONY: clean-nwk_ip-2f-core-2f-source-2f-http
